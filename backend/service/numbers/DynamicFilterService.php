...
class DynamicFilterService extends BaseService {
    ...
    const DYNAMIC_FILTER_TYPES = [
        ...
        ['type'=>31, 'label'=>'x上期开奖号码每个位置对数的全倒', 'params'=>['x'=>''], 'desc'=>"[1取2除]上期开奖的号码每个位置变成对数后全倒：<br>1、对数为：0-5 1-6 2-7 3-8 4-9（相减为5）<br>2、例如上期开：1234，则生成：6234、1734、1284、1239的全倒组合<br>3、最终去重后得到过滤号码", 'playway'=>[1, 2, 3]],
    ];
