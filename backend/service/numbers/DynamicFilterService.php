...
class DynamicFilterService extends BaseService {
    ...
    const DYNAMIC_FILTER_TYPES = [
        ...
        ['type'=>27, 'label'=>'排除x位最近n个码的复试且z(1除0不除)双重', 'params'=>['x'=>'', 'n'=>'', 'k'=>''], 'desc'=>"排除x位最近n个码的复试：<br>x:1，n:6，则千位取最近6个号码的复试号码过滤掉<br>x:12，n:6，则千位和百位各取最近6个号码的复试号码过滤掉<br>k:0不除双重1除双重", 'playway'=>[3]],
    ];
