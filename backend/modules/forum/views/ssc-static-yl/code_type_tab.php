...
<div class="btn-group">
    <?= Html::a('四现带双热码', ['index', 'SscStaticYl[code_type]'=>501, 'SscStaticYl[type]'=>4, 'SscStaticYl[type_2]'=>1, 'SscStaticYl[type_3]'=>0, 'SscStaticYl[is_hots]'=>1], ['class' => 'btn btn-success', 'style' => 'margin-bottom:15px;']) ?>
</div>
||
<div class="btn-group">
