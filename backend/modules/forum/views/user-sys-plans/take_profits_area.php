...
<div class="row" style="border-width:2px;margin-top:3px;border-style:solid;border-color:#3c3c3c">
    <div class="col-lg-2 col-xs-6">
        <?= $form->field($model, 'area_all_qishus')->textInput()->label('1.区间统计期数') ?>
    </div>
    <div class="col-lg-2 col-xs-6">
        <?= $form->field($model, 'area_yl_qishus')->textInput()->label('1.区间遗漏期数') ?>
    </div>
    <div class="col-lg-2 col-xs-6">
        <?= $form->field($model, 'area_loss_start')->textInput()->label('2.亏x元起投(例如:3000)') ?>
    </div>
    <div class="col-lg-2 col-xs-6">
