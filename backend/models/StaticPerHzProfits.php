 ...
 */
class StaticPerHzProfits extends \common\models\base\BaseModel
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return StaticPerHzProfitsQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StaticPerHzProfitsQuery(get_called_class());
    }
}
