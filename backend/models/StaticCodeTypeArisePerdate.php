...
class StaticCodeTypeArisePerdate extends \common\models\base\BaseModel
{
    ...
    {
        return [
            [['type_2', 'type_3', 'type_22', 'type_2b', 'type_3b', 'type_4b', 'type_2_type_2b', 'type_2_type_3b', 'type_3n_2b', 'type_22b', 'type_log', 'lottery_type', 'created_at', 'updated_at'], 'integer'],
            [['updated_at'], 'required'],
            [['update_time'], 'safe'],
            [['date'], 'string', 'max' => 10],
        ];
    ...
    public function attributeLabels()
    {
        return [
            ...
            'type_2' => Yii::t('app', '双重'),
            'type_3' => Yii::t('app', '三重'),
            'type_22' => Yii::t('app', '双双'),
            'type_2b' => Yii::t('app', '两兄'),
            'type_3b' => Yii::t('app', '三兄'),
            'type_4b' => Yii::t('app', '四兄'),
            'type_2_type_2b' => Yii::t('app', '双重&两兄'),
            'type_2_type_3b' => Yii::t('app', '双重&三兄'),
            'type_3n_2b' => Yii::t('app', '三:双重+兄弟'),
            'type_22b' => Yii::t('app', '双两兄'),
            'type_log' => Yii::t('app', '对数'),
