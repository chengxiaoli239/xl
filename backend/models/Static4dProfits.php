...
/**
 * This is the model class for table "{{%static_4d_profits}}".
 *
 * @property int $id
 ...
 */
class Static4dProfits extends \common\models\base\BaseModel
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return Static4dProfitsQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new Static4dProfitsQuery(get_called_class());
    }
}
