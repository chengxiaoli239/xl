...
/**
 * This is the model class for table "{{%static_hz_arise_perdate}}".
 *
 * @property int $id
 ...
 */
class StaticHzArisePerdate extends \common\models\base\BaseModel
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%static_hz_arise_perdate}}';
    }
    ...
    /**
     * @inheritdoc
     * @return StaticHzArisePerdateQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StaticHzArisePerdateQuery(get_called_class());
    }
}
