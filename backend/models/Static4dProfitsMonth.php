...
/**
 * This is the model class for table "{{%static_4d_profits_month}}".
 *
 * @property int $id
 ...
 */
class Static4dProfitsMonth extends \common\models\base\BaseModel
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%static_4d_profits_month}}';
    }
    ...
    /**
     * @inheritdoc
     * @return Static4dProfitsMonthQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new Static4dProfitsMonthQuery(get_called_class());
    }
}
