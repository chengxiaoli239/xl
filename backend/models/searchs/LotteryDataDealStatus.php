...
use backend\models\LotteryDataDealStatus as LotteryDataDealStatusModel;

/**
 * LotteryDataDealStatus represents the model behind the search form of `backend\models\LotteryDataDealStatus`.
 */
class LotteryDataDealStatus extends LotteryDataDealStatusModel
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['status_desc', 'static4dPerDateProfits_status_desc', 'updateDs_status_desc', 'updateDsYL_status_desc', 'update3NumYL_status_desc', 'updateSdHzYL_status_desc', 'opProfitsPlans_status_desc', 'update_time'], 'safe'],
        ];
    }
    ...
    {
        $query = LotteryDataDealStatusModel::find();
