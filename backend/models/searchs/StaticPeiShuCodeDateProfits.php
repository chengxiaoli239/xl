...
use backend\models\StaticPeiShuCodeDateProfits as StaticPeiShuCodeDateProfitsModel;

/**
 * StaticPeiShuCodeDateProfits represents the model behind the search form of `backend\models\StaticPeiShuCodeDateProfits`.
 */
class StaticPeiShuCodeDateProfits extends StaticPeiShuCodeDateProfitsModel
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = StaticPeiShuCodeDateProfitsModel::find();
