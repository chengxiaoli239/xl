...
use backend\models\Static4dProfitsPerdate as Static4dProfitsPerdateModel;

/**
 * Static4dProfitsPerdate represents the model behind the search form of `backend\models\Static4dProfitsPerdate`.
 */
class Static4dProfitsPerdate extends Static4dProfitsPerdateModel
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = Static4dProfitsPerdateModel::find();
