...
use backend\models\Static4dProfitsDay as Static4dProfitsDayModel;

/**
 * Static4dProfitsDay represents the model behind the search form of `backend\models\Static4dProfitsDay`.
 */
class Static4dProfitsDay extends Static4dProfitsDayModel
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = Static4dProfitsDayModel::find();
