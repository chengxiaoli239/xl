...
class AgentUserBetLogs extends AgentUserBetLogsModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['access_token', 'account', 'bet_logs', 'bet_logs_n', 'bet_logs_codes_hz', 'bet_codes', 'bet_codes_op', 'desc', 'lottery_type', 'qihao', 'member_bet_time', 'update_time', 'from_type', 'from'], 'safe'],
