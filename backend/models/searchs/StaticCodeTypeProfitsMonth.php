...
use backend\models\StaticCodeTypeProfitsMonth as StaticCodeTypeProfitsMonthModel;

/**
 * StaticCodeTypeProfitsMonth represents the model behind the search form of `backend\models\StaticCodeTypeProfitsMonth`.
 */
class StaticCodeTypeProfitsMonth extends StaticCodeTypeProfitsMonthModel
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = StaticCodeTypeProfitsMonthModel::find();
