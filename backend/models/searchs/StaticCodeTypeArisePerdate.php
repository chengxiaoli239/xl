...
class StaticCodeTypeArisePerdate extends StaticCodeTypeArisePerdateModel
{
    ...
    {
        return [
            [['id', 'type_2', 'type_3', 'type_22', 'type_2b', 'type_3b', 'type_4b', 'type_2_type_2b', 'type_2_type_3b', 'type_3n_2b', 'type_22b', 'type_log', 'lottery_type', 'created_at', 'updated_at'], 'integer'],
