...
/**
 * This is the model class for table "{{%static_pei_shu_code_date_profits}}".
 *
 * @property int $id
 ...
 */
class StaticPeiShuCodeDateProfits extends \common\models\base\BaseModel
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%static_pei_shu_code_date_profits}}';
    }
    ...
    /**
     * @inheritdoc
     * @return StaticPeiShuCodeDateProfitsQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StaticPeiShuCodeDateProfitsQuery(get_called_class());
    }
}
