...
class Static3numArisePerdate extends \common\models\base\BaseModel
{
    ...
    {
        return [
            [['codes_289', 'codes_046', 'codes_456', 'codes_125', 'codes_589', 'codes_025', 'codes_467', 'codes_256', 'codes_128', 'codes_347', 'codes_134', 'codes_258', 'codes_124', 'codes_014', 'codes_147', 'codes_345', 'codes_678', 'codes_238', 'codes_239', 'codes_028', 'codes_268', 'codes_389', 'codes_348', 'created_at', 'updated_at'], 'integer'],
            [['updated_at'], 'required'],
            [['update_time'], 'safe'],
            [['date'], 'string', 'max' => 10],
        ];
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('app', 'ID'),
            'date' => Yii::t('app', '日期'),
            'codes_289' => Yii::t('app', '289'),
            'codes_046' => Yii::t('app', '046'),
            'codes_456' => Yii::t('app', '456'),
            'codes_125' => Yii::t('app', '125'),
            'codes_589' => Yii::t('app', '589'),
            'codes_025' => Yii::t('app', '025'),
            'codes_467' => Yii::t('app', '789'),
            'codes_256' => Yii::t('app', '256'),
            'codes_128' => Yii::t('app', '128'),
            'codes_347' => Yii::t('app', '347'),
            'codes_134' => Yii::t('app', '134'),
            'codes_258' => Yii::t('app', '258'),
            'codes_124' => Yii::t('app', '124'),
            'codes_014' => Yii::t('app', '014'),
            'codes_147' => Yii::t('app', '147'),
            'codes_345' => Yii::t('app', '345'),
            'codes_678' => Yii::t('app', '678'),
            'codes_238' => Yii::t('app', '238'),
            'codes_239' => Yii::t('app', '239'),
            'codes_028' => Yii::t('app', '028'),
            'codes_268' => Yii::t('app', '268'),
            'codes_389' => Yii::t('app', '389'),
            'codes_348' => Yii::t('app', '348'),
