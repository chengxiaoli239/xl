            ...
            F.prototype.renderData = function(e, n, o, r) {
                            ...
                            function(a, l) {
                                ...
                                0 !== l.length && (r || (l[d.config.indexName] = a), c.eachCols(function(n, r) {
                                    var c = r.field || n,
                                        h = s.index + "-" + r.key,
                                        p = l[c];
                                    var noDataContent = r.noDataContent === true ? true : false;
                                        ...
                                        var v = ['<td data-field="' + c + '" data-key="' + h + '" ' +
                                            function() {
                                                ...
                                                return r.edit && e.push('data-edit="' + r.edit + '"'),
                                                    ...
                                                    r.templet && !noDataContent && e.push('data-content="' + p + '"'),
                ...
                return c.key = s.id || s.index,
                    ...
                    r ? m() : 0 === u.length ? (c.renderForm(), c.layFixed.remove(), c.layMain.find("tbody").html(""), c.layMain.find("." + f).remove(), c.layMain.append('<div class="' + f + '">' + s.text.none + "</div>")) : (m(), c.renderTotal(u), void(s.page && (s.page = t.extend({
                            ...
                            count: o,
                            limit: s.limit,
                            limits: s.limits || [10, 20, 30, 100, 200, 500, 1000],
                            groups: 3,
                            layout: ["prev", "page", "next", "skip", "count", "limit"],
                            prev: '<i class="layui-icon">&#xe603;</i>',
                            next: '<i class="layui-icon">&#xe602;</i>',
                            jump: function(e, t) {
                                if( !!window.Tnmc && !!window.Tnmc.tableCheckboxTableRowCount )
                                {
                                    window.Tnmc.tableCheckboxTableRowCount(0);
                                }
