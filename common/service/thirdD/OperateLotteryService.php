...
class OperateLotteryService extends CommonBaseService
{
    ...
    public static function runZhiXuan(object $betRow, $kjCode=''){
        ...
        $kjCode3 = $kjCode[0].$kjCode[2].$kjCode[4];
        #$kjCode3 = '123';
        ...
        $logArr = ['status'=>$status, 'bouns'=>$bouns, 'Odds'=>$Odds, 'count'=>$count, 'betCodes'=>$betCodes, 'kjCode'=>$kjCode, 'kjCode3'=>$kjCode3, 'betRecord'=>$betRow->getAttributes()];
