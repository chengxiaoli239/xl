            ...
            switch ($method_id){
                ...
                case MethodMatchService::METHOD_ID_YIMADING: # 一码定
                    ...
                    if(strpos($betCodes, 'X')===false) {
                        $betCodes = AoZhou5BetService::resetOneFixed($betCodes);
                    }
                    break;
                case MethodMatchService::METHOD_ID_ERMADING: # 二码定
                    ...
                    if(strpos($betCodes, 'X')===false){
                        $betCodes = AoZhou5BetService::resetTwoFixed($betCodes);
                    }
                    break;
                ...
                case MethodMatchService::METHOD_ID_DW_ZX_FS: # 定位-直选复式
                    $betCodes = AoZhou5BetService::resetOneFixedZhiXuanFuShi($betCodes);
                    break;
                case MethodMatchService::METHOD_ID_QD: # 全倒
                    $betCodes = AoZhou5BetService::resetOneQuanDao($betCodes);
                    break;
