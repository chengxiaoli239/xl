 ...
 * @property int $has_reply 回复状态0:未回复2成功3失败4无需回复5二次回复
 * @property string $reply_content 回复内容
 * @property int $is_simulate 是否模拟投注0否1是
 * @property string $site_account 盘口账号
...
class Bets extends \common\models\base\BaseModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['update_at'], 'safe'],
            [['qihao'], 'string', 'max' => 20],
            [['kj_codes', 'new_msg_id', 'site_account'], 'string', 'max' => 24],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'new_msg_id' => Yii::t('app', '消息ID'),
            'is_need_confirm' => Yii::t('app', '是否需确认'),
            'reply_type' => Yii::t('app', '回复类型：0即时1打包'),
            'has_reply' => Yii::t('app', '回复状态0:未回复2成功3失败4无需回复5二次回复'),
            'reply_content' => Yii::t('app', '回复内容'),
            'is_simulate' => Yii::t('app', '是否模拟投注0否1是'),
            'site_account' => Yii::t('app', '盘口账号'),
