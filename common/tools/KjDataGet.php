    ...
    public static function grabKjData(): bool
    {
        ...
        foreach ($lottery_types as $lotteryData){
            try {
                ...
                Tool_Common::log('/kj_data/'.__FUNCTION__, 'INFO', '开奖数据抓取', ['lottery_type'=>$lottery_type, 'typeGroupName'=>$lotteryData['typeGroupName'], 'cacheTime'=>$cacheTime, 'flag'=>$flag, 'status1'=>$status1, 'err_msg1'=>$err_msg1]);
