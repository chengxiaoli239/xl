    ...
    public static function afterKj($lottery_type = DEFAULT_LOTTERY_TYPE): array
    {
        ...
        switch (true){
            ...
            case $lottery_type == LotteryType::ETH_10M: // 以太10分
                ...
                push_queue(Update1NumYlJob::class, ['qihao'=>$qihao, 'lottery_type'=>$lottery_type, 'title'=>$lottery_name, 'business_id'=>$qihao]);
                push_queue(PeiShuProfitsJob::class, ['qihao'=>$qihao, 'lottery_type'=>$lottery_type, 'title'=>$lottery_name, 'business_id'=>$qihao]);
                push_queue(CommonDataStaticsJob::class, ['qihao'=>$qihao, 'lottery_type'=>$lottery_type, 'date'=>$tmpDate, 'title'=>$lottery_name, 'business_id'=>$qihao]);
                push_queue(StaticAll2NumsYlJob::class, ['qihao'=>$qihao, 'lottery_type'=>$lottery_type, 'title'=>$lottery_name, 'business_id'=>$qihao]);
                push_queue(StaticHzProfitsJob::class, ['qihao'=>$qihao, 'lottery_type'=>$lottery_type, 'title'=>$lottery_name, 'business_id'=>$qihao]);
